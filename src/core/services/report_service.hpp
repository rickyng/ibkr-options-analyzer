...
struct ReportData {
    std::vector<analysis::Position> positions;
    std::vector<db::PositionRepository::RiskSummary> risk_summaries;
    std::vector<db::PositionRepository::ExposureInfo> exposures;
