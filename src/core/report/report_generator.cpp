...
std::string ReportGenerator::generate_portfolio_summary(
    ...
    section << std::left << std::setw(30) << "Capital at Risk:"
            << std::right << std::setw(20) << format_currency(portfolio_risk.total_capital_at_risk) << "\n";
...
std::string ReportGenerator::format_currency(double value) {
